...
export const MOCK_SAVED_SEARCHES: SavedSearch[] = [
  {
    name: 'חיפוש מיילים מהשבוע האחרון עם קבצים מצורפים מסוג PDF בלבד44343434',
    username: 'user_ori',
  ...
  {
    name: 'תכתובות עם לקוחות חדשים ברבעון הראשון',
    username: 'user_ori',
  ...
  {
    name: 'מיילים ממחלקת משאבי אנוש בנושא חופשות',
    username: 'user_ori',
  ...
  {
    name: 'Search for quarterly reports from finance',
    username: 'user_david',
    date: new Date('2026-02-13'),
    isPinned: false,
  },
  {
    name: 'All emails with attachment from HR department',
    username: 'user_sarah',
